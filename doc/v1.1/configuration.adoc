...
If this is not set, the topic prefix is derived from the `vda5050:interfaceName`, `vda5050:manufacturer`, and `vda5050:serialNumber` properties as follows: `<interfaceName>/v1/<manufacturer>/<serialNumber>`.
