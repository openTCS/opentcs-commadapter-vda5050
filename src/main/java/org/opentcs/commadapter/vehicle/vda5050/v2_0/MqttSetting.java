...
import static org.opentcs.commadapter.vehicle.vda5050.v2_0.ObjectProperties.PROPKEY_VEHICLE_TOPIC_CONNECTION_NAME;
import static org.opentcs.commadapter.vehicle.vda5050.v2_0.ObjectProperties.PROPKEY_VEHICLE_TOPIC_CONNECTION_QOS;
import static org.opentcs.commadapter.vehicle.vda5050.v2_0.ObjectProperties.PROPKEY_VEHICLE_TOPIC_FACTSHEET_NAME;
import static org.opentcs.commadapter.vehicle.vda5050.v2_0.ObjectProperties.PROPKEY_VEHICLE_TOPIC_FACTSHEET_QOS;
import static org.opentcs.commadapter.vehicle.vda5050.v2_0.ObjectProperties.PROPKEY_VEHICLE_TOPIC_INSTANT_ACTIONS_NAME;
import static org.opentcs.commadapter.vehicle.vda5050.v2_0.ObjectProperties.PROPKEY_VEHICLE_TOPIC_INSTANT_ACTIONS_QOS;
import static org.opentcs.commadapter.vehicle.vda5050.v2_0.ObjectProperties.PROPKEY_VEHICLE_TOPIC_ORDER_NAME;
import static org.opentcs.commadapter.vehicle.vda5050.v2_0.ObjectProperties.PROPKEY_VEHICLE_TOPIC_ORDER_QOS;
import static org.opentcs.commadapter.vehicle.vda5050.v2_0.ObjectProperties.PROPKEY_VEHICLE_TOPIC_PREFIX;
import static org.opentcs.commadapter.vehicle.vda5050.v2_0.ObjectProperties.PROPKEY_VEHICLE_TOPIC_STATE_NAME;
import static org.opentcs.commadapter.vehicle.vda5050.v2_0.ObjectProperties.PROPKEY_VEHICLE_TOPIC_STATE_QOS;
 ...
 * @param factsheetTopicName The name of the topic to subscribe to for receiving factsheet messages
 * from the vehicle (already including the topic prefix.)
 * @param factsheetTopicQos The QoS to be used for subscribing to the factsheet topic.
...
public record MqttSetting(
    ...
    @Nonnull
    String factsheetTopicName,
    @Nonnull
    QualityOfService factsheetTopicQos,
    @Nonnull
    ...
    return Optional.of(
        new MqttSetting(
            ...
            Optional.ofNullable(vehicle.getProperty(PROPKEY_VEHICLE_TOPIC_VISU_QOS))
                ...
                .orElse(QualityOfService.AT_MOST_ONCE),
            prefix + "/" + Optional.ofNullable(
                vehicle.getProperty(PROPKEY_VEHICLE_TOPIC_FACTSHEET_NAME)
            )
                .filter(s -> !s.isBlank())
                .orElse("factsheet"),
            Optional.ofNullable(vehicle.getProperty(PROPKEY_VEHICLE_TOPIC_FACTSHEET_QOS))
                .map(propValue -> toQos(propValue, QualityOfService.AT_MOST_ONCE))
                .orElse(QualityOfService.AT_MOST_ONCE),
            prefix + "/" + Optional.ofNullable(
